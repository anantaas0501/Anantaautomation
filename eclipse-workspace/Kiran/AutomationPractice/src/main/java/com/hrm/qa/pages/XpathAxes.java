...
//		xpathusingcssforssccgl();
	...
	public static void xpathaxesforLOTR() throws InterruptedException {
		...
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@class='button-section mb-4']/div//button[contains(text(),' Validate Page')]")).click();
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@class='button-section mb-4']/div//following::button[contains(text(),' Save Progress')]")).click();
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@class='container']/preceding::div//ul//following::button[@type='button']//child::span[contains(text(),'Delete Transparency Declaration')]")).click();
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@id='modalPayLOTRFeesPayment']/preceding::p//following::br/following::strong//following::div[@id='deleteTDModel']//preceding-sibling::button")).click();
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@class='form-group col-lg-5']//following::button[contains(text(),' + Add Manual Entry Land ')]")).click();
		Thread.sleep(3000);
		d.findElement(By.xpath("//div[@class='form-row']//div//following::input[@id='LegalDescription']")).sendKeys("abcd");
